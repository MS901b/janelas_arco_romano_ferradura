	var codigo_do_software = "";
	var nome_do_software = "Janelas em Arcos Romano e Ferradura";
	...
	var FichaTecnica = $H({
		...
		tema: {
			titulo: 'Tema',
			conteudo: 'Numeros e Funções, Geometria e Medidas'
		},
		sinopse: {
			titulo: 'Sinopse',
			conteudo: 'Numeros e Funções, Geometria e Medidas'
		...
		conteudos: {
			titulo: 'Conteúdo',
			conteudo: 'Funções: Função quadrática; Geometria: perímetro, área de figuras planas.'
		},
		objetivos: {
			titulo: 'Objetivos',
			conteudo: '1. Despertar a percepção para a variação de valores de uma função de uma variável; 2. Modelar matematicamente uma situação por meio de uma função, determinando restrições de seu domínio; 3. Investigar o comportamento de uma função polinomial do segundo grau – seus valores máximos e mínimos.'
		},
		duracao: {
			titulo: 'Duração',
